...
public class Deck : MonoBehaviour
{
    ...
    private List<string> cardButtonNames;
    public List<Card> cards;
    private List<Card> buttonCards;
    ...
    public void MakeCards()
    {
        ...
        for (int i = 0; i < cardNames.Count; i++)
        {
            ...
            cgo.transform.localPosition = new Vector3(0f, 4.5f, 0f);//new Vector3((i % 8) * 3, i / 8 * 4, 0);
            ...
            card.transform.localScale = new Vector3(0.6f, 0.6f, 0.05f);
